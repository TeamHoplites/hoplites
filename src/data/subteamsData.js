export const subteamsData = {
  ...
  transmission: {
    ...
    members: [
      ...
      { name: 'Avinash', role: 'member', photo: '/assets/avinash.jpeg', instagram: '#', linkedin: '#' },
      { name: 'Karthikeyan', role: 'member', photo: '/assets/karthikeyan.jpg', instagram: '#', linkedin: '#' },
  ...
  steering: {
    name: 'Steering',
    desc: 'Handling dynamics and precision steering systems.',
    icon: '⚙️',
    members: [
  ...
  braking: {
    name: 'Braking',
    desc: 'Braking system design, performance tuning and safety compliance.',
    icon: '🛑',
    members: [
  ...
  "suspension and wheel assembly": {
    name: 'Suspension and Wheel Assembly',
  ...
  autonomous: {
    name: 'Autonomous',
    desc: 'Perception systems, path planning and driverless controls',
    icon: '🤖',
    members: [
      { name: 'Dhivinash', role: 'leader', photo: '/assets/dhivinash.jpg', instagram: '#', linkedin: '#' },
  ...
  innovation: {
    name: 'Innovation',
    desc: 'Experimental design, prototyping and futuristic concepts',
    icon: '💭',
    members: [
      { name: 'Dhiviash', role: 'leader', photo: '/assets/dhivinash.jpg', instagram: '#', linkedin: '#' },
      { name: 'Kamesh', role: 'member', photo: '/assets/kamesh.jpg', instagram: '#', linkedin: '#' },
